	...
	$(
			function() {
				$("#locationCount").change(function(){
					//alert($("#locationCount").val());
					location="${pageContext.request.contextPath}/naked/second/getImage6Ad.htm?locationFloor="+$("#locationCount").val()+"&categoryId="+$("#categoryId").val();
			...
			<div class="classify fixed">
						...
						<div class="vtitle1">
							<a
								href="${pageContext.request.contextPath}/naked/second/getFocusCarousel.htm?categoryId=${categoryId }">焦点活动管理</a>
											...
											<div class="vtitle1"><a
								href="${pageContext.request.contextPath}/naked/second/getRecommendProduct.htm?categoryId=${categoryId }">最热商品推荐</a>
								</div>
							<%-- <div class="vtitle1">
							<a
				...
				<div class="fr_ty">
					<form id="image6AdForm"
						...
						method="post">
						<input type="hidden" name="pageType" value="301" /> <input
							type="hidden" name="locationType" value="6" /> <input id="categoryId" type="hidden" name="category"
								value="${categoryId}" />
						<dl class="fixed">
