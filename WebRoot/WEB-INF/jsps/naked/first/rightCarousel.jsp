...
<script type="text/javascript">
	...
	$(function() {
		$("#locationCount")
				.change(
						function() {
							location = "${pageContext.request.contextPath}/naked/first/getRightCarousel.htm?locationFloor="
									+ $(this).val();
...
<script type="text/javascript">
	...
	function deleteImageAd(id, adId, locationId) {
		$
				.ajax({
					url : "${pageContext.request.contextPath}/naked/imageAd/deleteImageAd.json",
					type : "post", //请求类型
					async : false,//默认true异步请求 ，false同步请求 
					data : {
						id : id,
			...
			<div class="classify fixed">
				...
				<div class="fl">
					<div class="shrink">
						...
						<div class="vtitle1">
							<a
								href="${pageContext.request.contextPath}/naked/first/getImage6Ad.htm?locationFloor=1">右側标准广告位管理</a>
						</div>
