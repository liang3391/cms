...
<div id="wapper">
  <div class="main fixed">
    ...
    <div class="box">
      <h2><a href="#">综合管理后台</a> > <a href="#">产品及活动管理</a> > <a href="#">裸价体验</a> > 
      <c:choose>
        ...
        <div class="edit_right"> 
          ...
          <div class="edit_s1">
            ...
            <div id="edit_form" class="edit_form">
              <ul id="oEul">
                <li>
                  <label><span><em>*</em>体验价：</span></label>
                  <input type="hidden" name="productCode" value="${prdCode}"/>
                  <input type="hidden" name="version" value="${ver}"/>
                  <input type="hidden" name="prdAct.version" value="${ver}"/>
                  <input type="hidden" name="from" value="${from}"/>
                  <input type="hidden" name="prdAct.productCode" value="${prdCode}" id="prdCode"/>
          ...
          <div class="edit_s1 top15">
            ...
            <div class="time_show">
              <p>活动时间：
                ...
                到
                <input class="Wdate" type="text" id="offTime" name="offTime" value="<fmt:formatDate value="${actDto.prdAct.offTime}" pattern="yyyy-MM-dd hh:mm"/>" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',readOnly:true})">
              </p>
              <span id="day">当前选择活动时间天数:</span>
            </div>
          </div>
...
<script type="text/javascript" src="<%=basePath%>/js/product/activity.js"></script>
