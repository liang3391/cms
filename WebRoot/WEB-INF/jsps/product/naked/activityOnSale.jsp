			...
			<div class="main fixed">
				...
				<div class="box">
					...
					<div class="fr" id="obj_le">
						<div class="right_box">
				          <div class="lt_search">
				          <form id="selectForm" name="selectForm" action="getOnSaleProductList.htm?type=0" method="post">
				                ...
				                <ul>
									...
									<li>
										...
										<select name="status" >
											...
											<option value="1" ${searchAct.status==1?"selected":""}>等待体验开始</option>
											<option value="2" ${searchAct.status==2?"selected":""}>体验中</option>
										</select>
									</li>
				                </ul>
				              </div>
				          ...
				          <div class="sales">
				            ...
				            <form action="<%=basePath%>/prd/stopOnSaleProduct.htm?type=0" method="post" name="productForm" id="productForm">
				              <table class="_Tabl">
				                <thead>
				                  <tr>
				                     <th width="165	">产品名称</th>
			                         <th width="93">体验价</th>
			                         <th width="125">开放体验人数</th>
			                         <th width="125">累计体验人数</th>
					                        ...
					                        <td><!--活动状态-->
					                            <div class="mtd_2">
					                            		<c:if test="${act.status==1}">
					                            			<p>等待体验开始</p>
							                                <p class="FF6600">距离体验开始</p>
							                                <p class="FF6600"  id="${act.id}_timer"><script>countDown_colon("${act.id}_timer","${act.onTime}",0)</script></p>
					                            		</c:if>
					                            		<c:if test="${act.status==2}">
					                            			<p class="green">体验中</p>
							                                <p class="FF6600">距离体验结束</p>
							                                <p class="FF6600"  id="${act.id}_timer"><script>countDown_colon("${act.id}_timer","${act.offTime}",0)</script></p>
					                            		</c:if>
					                            </div>
					                        </td>
					                        <td><!--操作-->
					                            <div class="mtd_4">
					                                <ul>
					                                   <li><a class="negativeClass abutton" href="#">终止体验</a></li>
					                                </ul>
					                            </div>
					                        </td>
					                    </tr>
