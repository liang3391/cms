			...
			<div class="main fixed">
				...
				<div class="box">
					...
					<div class="fr" id="obj_le">
						<div class="right_box">
				          <div class="lt_search">
				          <form id="selectForm" name="selectForm" action="getEditingProductList.htm?type=0" method="post">
				          ...
				          <div class="sales">
				            ...
				            <form action="<%=basePath%>/prd/removeEndSaleProduct.htm?redirectUrl=/prd/getEditingProductList.htm?type=0" method="post" name="productForm" id="productForm">
				              <table class="_Tabl">
				                <thead>
				                  <tr>
					                ...
					                <tbody>
					                    ...
					                    <tr class="lt_main">
					                        ...
					                        <td><!--操作-->
					                             <div class="mtd_4">
					                                <ul>
													    <li><a target="_blank" class="abutton" href="<%=basePath%>/prd/getPrd.htm?prdCode=${act.productCode}&ver=${act.version}&type=0&from=editing">编辑产品</a></li>
													     <li><a target="_blank" class="abutton" href="<%=basePath%>/prd/getActivity.htm?prdCode=${act.productCode}&ver=${act.version}&type=0&from=editing">编辑活动</a></li>
