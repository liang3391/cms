	...
	<body>
		<div id="wapper">
			<div class="main fixed">
				...
				<div class="box">
					<h2><a href="#">综合管理后台</a> > <a href="#">产品及活动管理</a> > <a href="#">裸价体验</a> > <em class="green">重新申报产品管理</em></h2>
					<div class="fl fixed">
						<!--左侧menu-->
		        ...
		        <div class="right_box">
		          <div class="lt_search">
		           <form id="selectForm" action="getActReportList.htm?type=0&prdStatus=1" method="post">
		          ...
		          <div class="sales">
		            <div id="sales_pro" class="sales_products">
		                <div id="Tab1">
		                   <div class="Menubox ">
		                        <ul class="flag_tab">
		                             <li id="one1" onclick="setTab('one',1,2)"  class="hover"><a href="javascript:;">待售产品申报</a></li>
		                             <li id="one2" onclick="setTab('one',2,2)" ><a href="getActReportList.htm?type=0&prdStatus=2">在售产品申报</a></li>
		                        </ul>
		                    </div>
		                              ...
		                              <table class="_Tabl">
		                                    <thead>
		                                      <tr>
		                                        ...
		                                        <th width="88">规格</th>
		                                        <th width="118">本次开放体验人数</th>
		                                        <th width="118">体验价</th>
		                                        <th width="120">编辑中活动</th>
		                                        <th width="120">操作</th>
		                                      </tr>
		                                    </thead>
		                                    <form action="<%=basePath%>/act/removePrdAct.htm?type=0&prdStatus=1" method="post" id="removeForm">
		                                    ...
		                                    <tbody>
		                                        ...
		                                        <tr class="lt_main">
		                                            ...
		                                            <td><!--操作-->
		                                               <div class="mtd_4">
		                                                    <ul>
														        <li><a target="_blank" class="abutton" href="<%=basePath%>/prd/getPrd.htm?prdCode=${act.productCode}&ver=${act.version}&type=0&from=report">编辑产品</a></li>
															    <li><a target="_blank" class="abutton" href="<%=basePath%>/prd/getActivity.htm?prdCode=${act.productCode}&ver=${act.version}&type=0&from=report">编辑活动</a></li>
