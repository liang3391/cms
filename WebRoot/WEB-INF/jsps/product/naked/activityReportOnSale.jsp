	...
	<body>
		<div id="wapper">
			<div class="main fixed">
		        ...
		        <div class="right_box">
		          <div class="lt_search">
		           <form id="selectForm" action="getActReportList.htm?type=0&prdStatus=2" method="post">
		          ...
		          <div class="sales">
		            <div id="sales_pro" class="sales_products">
		                <div id="Tab1">
		                   <div class="Menubox ">
		                        <ul class="flag_tab">
		                             <li id="one1" onclick="setTab('one',1,2)" ><a href="getActReportList.htm?type=0&prdStatus=1">待售产品申报</a></li>
		                        ...
		                        <div id="con_one_1"  style="display:none;">
		                         ...
		                         <div id="con_one_2">
		                              <table class="_Tabl">
		                                    ...
		                                    <form action="<%=basePath%>/act/removePrdAct.htm?type=0&prdStatus=2" method="post" id="removeForm">
