			...
			<div class="main fixed">
				...
				<div class="box">
					...
					<div class="fr" id="obj_le">
						<div class="right_box">
							<div class="lt_search">
								<form id="selectForm" name="selectForm" action="getActCheckList.htm?type=0&prdStatus=2" method="post">
								...
								<div id="sales_pro" class="sales_products">
									<div id="Tab1">
										<div class="Menubox ">
											<ul class="flag_tab">
												<li id="one1" onclick="setTab('one',1,2)">
													<a href="getActCheckList.htm?type=0&prdStatus=1">待售产品复核</a>
												</li>
										...
										<div class="Contentbox">
											...
											<div id="con_one_2" >
												<form action="<%=basePath%>/act/reportActivity.htm?type=0&prdStatus=2" method="post" name="reportForm" id="reportForm">
												<table class="_Tabl">
													<thead>
														<tr>
