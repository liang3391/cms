			...
			<div class="main fixed">
				...
				<div class="box">
					...
					<div class="fr" id="obj_le">
						<div class="right_box">
				          <div class="lt_search">
				          <form id="selectForm" name="selectForm" action="getEndSaleProductList.htm?type=1" method="post">
				          ...
				          <div class="sales">
				            ...
				            <form action="<%=basePath%>/prd/removeEndSaleProduct.htm?redirectUrl=/prd/getEndSaleProductList.htm?type=1" method="post" name="productForm" id="productForm">
				              <table class="_Tabl">
				                <thead>
				                  <tr>
				                    <th width="165">产品名称</th>
				                    <th width="75">保证金</th>
				                    <th width="103">本次开放试用人数</th>
				                    <th width="103">本次累计试用人数</th>
