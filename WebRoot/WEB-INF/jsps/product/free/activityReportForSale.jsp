	...
	<body>
		<div id="wapper">
			<div class="main fixed">
		        ...
		        <div class="right_box">
		          <div class="lt_search">
		           <form id="selectForm" action="getActReportList.htm?type=1&prdStatus=1" method="post">
		                ...
		                <div id="Tab1">
		                   <div class="Menubox ">
		                        <ul class="flag_tab">
		                             ...
		                             <li id="one2" onclick="setTab('one',2,2)" ><a href="getActReportList.htm?type=1&prdStatus=2">在售产品申报</a></li>
		                        </ul>
		                    </div>
		                    <div class="Contentbox">
		                        ...
		                        <div id="con_one_1" >
		                              <table class="_Tabl">
		                                    ...
		                                    <form action="<%=basePath%>/act/removePrdAct.htm?type=1&prdStatus=1" method="post" id="removeForm">
