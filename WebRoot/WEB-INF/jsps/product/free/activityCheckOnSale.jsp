			...
			<div class="main fixed">
				...
				<div class="box">
					...
					<div class="fr" id="obj_le">
						<div class="right_box">
							<div class="lt_search">
								<form id="selectForm" name="selectForm" action="getActCheckList.htm?type=1&prdStatus=2" method="post">
								...
								<div id="sales_pro" class="sales_products">
									<div id="Tab1">
										<div class="Menubox ">
											<ul class="flag_tab">
												<li id="one1" onclick="setTab('one',1,2)">
													<a href="getActCheckList.htm?type=1&prdStatus=1">待售产品复核</a>
												</li>
												<li id="one2" onclick="setTab('one',2,2)" class="hover">
													<a href="javascript:;">在售产品复核</a>
												</li>
											</ul>
										</div>
										<div class="Contentbox">
											...
											<div id="con_one_2" >
												<form action="<%=basePath%>/act/reportActivity.htm?type=1&prdStatus=2" method="post" name="reportForm" id="reportForm">
												<table class="_Tabl">
													<thead>
														<tr>
															<th width="165"> 产品名称 </th>
															<th width="65"> 规格 </th>
															<th width="110"> 累计试用人数 </th>
															<th width="65"> 保证金 </th>
															<th width="110"> 开放试用人数 </th>
