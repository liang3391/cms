...
<div id="wapper">
  <div class="main fixed">
    ...
    <div class="box">
      <h2><a href="#">综合管理后台</a> > <a href="#">产品及活动管理</a> > <a href="#">免费试用</a> > <em class="green">产品回收站</em></h2>
      <div class="fl fixed">
         <!--左侧menu-->
      ...
      <div class="fr" id="obj_le">
       <div class="right_box">
          <div class="lt_search">
            <form id="selectForm" name="selectForm" action="<%=basePath%>/prd/getRecycleBinList.htm?type=1" method="post">
          ...
          <div class="sales">
            <div id="sales_pro" class="sales_products">
              <table class="_Tabl"><!---->
                ...
                <form action="<%=basePath%>/prd/recoverPrdFromRecycle.htm?type=1" method="post" id="recoverForm">
                    ...
                    <tr class="lt_main">
                        ...
                        <c:if test="${act.reportStatus==2}">
	                        ...
	                        <td>
	                            <div class="mtd_4">
	                                <ul>
	                                    <li><a class="negativeClass abutton1" href="#">恢复到试用结束活动产品</a></li>
	                                </ul>
	                            </div>
	                        </td>
                        </c:if>
...
<div id="recycle" class="pop-box bg_box_green">
     ...
     <div class="pop_cont">
          <ul>
			 ...
			 <li>在售只能恢复到试用结束的活动产品，并可以在前端展示。</li>
          </ul>
