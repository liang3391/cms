...
<div class="preview_produce">
    ...
    <div class="shangpin_text_wrap">
         ...
         <span class="w131">折扣：${prd.discount}</span> 
         ...
         <div class="w323 left"> 
          ...
          <span class="top5">开放体验：<em class="text_green"></em></span>
          ...
          <!--保证金/立即申请/倒计时 情况1-->
          <div class="lj_sq">
                <h2>体验价：<label></label></h2>
                <span class="mf"><input type="button" value=""></span>
          </div>
          <div class="line mt10 mb10"></div>
          <div class="djs_begin">
            <h3 class="begin">距离体验开始</h3>
          </div>
          <div class="line mt10 mb10"></div>
        </div>
    ...
    <div class="mude_wrap">
      <h3></h3>
      <p class="mt15" style="height:40px;"></p>
      <h4></h4>
      <p class="mt15"> 性别要求：</br>
        年龄要求：</br>
        体验等级：</br>
        会员类别：</br>
        本品牌勋章： </p>
      <p class="top30">地区要求：大陆地区</br>
        不参加省份：<span></span> <span></span> <span></span> </p>
    </div>
    <!--mude_wrap end-->
    <div class="share_wrap"> 
    <a href="javascript:;" class="fenx"><span></span>分享</a> <a href="javascript:;" class="but_soucang"><span></span>收藏</a> <a href="javascript:;">品牌订阅</a> <a href="javascript:;">举报</a>
    </div>
     <!--share_wrap-->  
 </div>
 <!--area_a-->   
