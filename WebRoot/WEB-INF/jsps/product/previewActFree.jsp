...
<div class="preview_produce">
    ...
    <div class="shangpin_text_wrap">
         ...
         <div class="w323 left"> 
          ...
          <!--保证金/立即申请/倒计时 情况1-->
          <div class="lj_sq">
                <h2>保证金：<em></em><label>￥${prd.activity.price}</label></h2>
                <span class="lv"><input type="button" value=""></span>
          </div>
          <div class="line mt10 mb10"></div>
          <div class="djs_begin">
            <h3 class="begin">距离申请开始</h3><strong id="countDown"></strong>
          </div>
          <div class="line mt10 mb10"></div>
        </div>
    ...
    <div class="mude_wrap mf_bg">
      <h3></h3>
      <p style="height:42px;" class="mt10">${prd.activity.purpose}</p>
      <h4></h4>
      <p class="mt15"> 性别要求：
      	<c:choose>
      ...
      <h5></h5>
      <p class="mt10">请确认收货后${prd.activity.reportDay}天内提交报告</p>
    </div>
    <!--mude_wrap end-->
