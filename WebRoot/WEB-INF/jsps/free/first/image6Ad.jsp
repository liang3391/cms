...
function release() {
	...
	function toCategoryPage(){
		...
		if(categoryOne==0&&categoryTwo==0){
			...
			location="${pageContext.request.contextPath}/free/getTopCarousel.htm?categoryOne="+categoryOne+"&categoryTwo="+categoryTwo;
		}
	}
	$(function() {
		$("#locationCount").change(function(){
				...
				location= "${pageContext.request.contextPath}/free/first/getImage6Ad.htm?locationFloor="+$(this).val();
	...
	<div id="wapper">
		...
		<%@include file="/WEB-INF/jsps/free/includes/topMenu-free.jsp"%>
			...
			<div class="classify fixed">
				<h2>
					<a href="#">综合管理后台</a> &gt; <a href="#">页面管理</a> &gt; <a href="#">免费试用验首页</a>
				...
				<div class="fl">
					<div class="shrink">
						...
						<div class="vtitle1"><a
								href="${pageContext.request.contextPath}/free/first/getRightCarousel.htm?locationFloor=1">右侧广告轮播管理</a></div>
						<div class="vtitle1 current">
							<a
								href="${pageContext.request.contextPath}/free/first/getImage6Ad.htm?locationFloor=1">右侧标准广告位管理</a>
						</div>
				...
				<div class="fr_ty">
					<form id="image6AdForm"
						...
						method="post">
						<input type="hidden" name="pageType" value="2" /> <input
