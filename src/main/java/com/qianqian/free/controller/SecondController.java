 ...
 */
@Controller("freeSecond")
@RequestMapping("free/second")
public class SecondController {
	/**
	 * 获取顶部轮播的返回路径
	 */
	private static final String TOP_CAROUSEL="free/second/topCarousel";
	/**
	 * 获得焦点轮播的返回路径
	 */
	private  static final String FOCUS_CAROUSEL ="free/second/focusCarousel";
	private  static final String RECOMMEND_PRODUCT ="free/second/recommendProduct";
	// 右侧轮播
	private static final String RIGHT_CAROUSEL = "free/second/rightCarousel";
	// 6个标准广告
	private static final String IMAGE6AD = "free/second/image6Ad";
