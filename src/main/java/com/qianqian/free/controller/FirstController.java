 ...
 * 
 * @Project : cms.maxtp
 * @Program Name: com.qianqian.free.controller.FirstController.java
 * @ClassName : FirstController
 * @Author : shenzhenxing
 * @CreateDate : 2014年5月28日 下午4:59:12
 */
@Controller("freeFirst")
@RequestMapping("free/first")
public class FirstController {

	// 顶部轮播的返回路径
	private static final String TOP_CAROUSEL = "free/first/topCarousel";
	// 焦点轮播的返回路径
	private static final String FOCUS_CAROUSEL = "free/first/focusCarousel";
	// 类目通栏的路径
	private static final String CATEGORY_COLUMN = "free/first/categoryColumn";
	// 右侧轮播
	private static final String RIGHT_CAROUSEL = "free/first/rightCarousel";
	// 6个标准广告
	private static final String IMAGE6AD = "free/first/image6Ad";
	// 类目钻展
	private static final String CATEGORY_SHOW = "free/first/categoryShow";
	...
	public String getCategoryColumn(Model model,String locationFloor) {
		...
		List<ImageAd> imageAds = imageAdService.getImageAdList(location);
		int count =locationService.getLocationCount(4,2,0);
