 ...
 * 裸价体验三级页面的控制器
 * @Project 	: cms.maxtp
 * @Program Name: com.qianqian.free.controller.ThirdController.java
 * @ClassName	: FirstController 
 * @Author 		: shenzhenxing 
 * @CreateDate  : 2014年5月28日 下午4:59:12
 */
@Controller("freeThird")
@RequestMapping("free/third")
public class ThirdController {
	/**
	 * 获取顶部轮播的返回路径
	 */
	private static final String TOP_CAROUSEL="free/third/topCarousel";
	private  static final String RECOMMEND_PRODUCT ="free/third/recommendProduct";
	@Resource
